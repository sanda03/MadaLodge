...
class Carousel {
  constructor(el) {
    ...
    this.carouselData = [
      {
        'id': '1',
        'src': 'img/brouillon/FaceApp_1589834408899.jpg',
      },
      {
        'id': '2',
        'src': 'img/hotels/luxury-pool-villa-spectacular-contemporary-design-digital-art-real-estate-home-house-property-ge.jpg',
      },
      {
        'id': '3',
        'src': 'img/brouillon/FaceApp_1589834408899.jpg',
